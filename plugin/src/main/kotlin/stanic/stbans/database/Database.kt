...
class Database {
    ...
    fun start() {
        ...
        Main.instance.db.statement!!.execute("create table if not exists ${Main.table} (player text, staff text, type text, reason text, date text, hour text, time long, id int, address, active int);")
